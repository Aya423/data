    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="container mx-auto max-w-6xl px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="bg-black/60 p-6 rounded-md flex items-center">
            <div>
              <p className="text-white font-oswald tracking-wide leading-relaxed uppercase">
          ...
          {/* الفيديو */}
          <div className="border-8 border-yellow-400 rounded-lg shadow-xl p-2 bg-yellow-50 flex">
